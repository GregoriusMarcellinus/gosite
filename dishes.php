        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/icn.png" width="152px" height="36px" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                       <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Beranda <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Mitra <span class="sr-only"></span></a> </li>
                            
							<?php
						if(empty($_SESSION["user_id"]))
							{
								echo '<li class="nav-item"><a href="login.php" class="nav-link active">Masuk</a> </li>
							  <li class="nav-item"><a href="registration.php" class="nav-link active">Registrasi</a> </li>';
							}
						else
							{
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Pilih UMKM</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pilih Produk Kesukaanmu</a></li>
...
?>								  
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              Produk <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rp<?php echo number_format($product['price'], 0, ',', '.'); ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Tambahkan" />
										</div>
										</form>
                                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Telepone: 081333131969</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Gabung Sekarang</h5>
                                   <p>Bergabunglah seperti UMKM lain yang mendapat manfaat dari kemitraan dengan kami.</p>
                                </div>
                            </div>
                        </div>
                    </div>
